    ...
    <div class="bg-[#161B22] rounded-[1.5rem] py-4 px-4 grid grid-cols-3">
        ...
        <div class="pt-5">
            ...
            <div class="relative space-x-1">
                ...
                <input wire:model="twitter" type="text" placeholder="x.com/ByteJana" class="input input-bordered bg-[#161B22] border-gray-500 focus:border-white text-white font-medium w-full max-w-xs pl-10"/>
            </div>
        </div>
        <div class="pt-5">
            <div class="label">
